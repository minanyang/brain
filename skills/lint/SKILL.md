...
allowed-tools: Bash(${CLAUDE_PLUGIN_ROOT}/scripts/resolve-vault.sh *) Bash(${CLAUDE_PLUGIN_ROOT}/scripts/lint.sh *) Bash(${CLAUDE_PLUGIN_ROOT}/scripts/finish.sh *) Bash(git show *) Read Glob Grep
---
